import { Ban, PlusCircle, PlusCircleIcon } from "lucide-react";
...
const EmptyState = ({ title, description, buttonText, href }: iAppProps) => {
  return (
    <div className=" flex  flex-col flex-1 h-full items-center justify-center rounded-md border border-dashed p-8">
      ...
      <p className=" max-w-sm text-balance mb-8 mt-2 text-center text-sm leading-tight text-muted-foreground">
        {description}
      </p>
